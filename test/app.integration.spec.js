...
describe('Test routes', () => {
  ...
  it('POST /bookmarks sends {"error": "required field(s) missing"} as json', (done) => {
    request(app)
      .post('/bookmarks')
      .send({})
      .expect(422)
  ...
  it(`POST /bookmarks sends { url: 'https://jestjs.io', title: 'Jest' } as json`, (done) => {
    request(app)
      .post('/bookmarks')
  ...
  describe('GET /bookmarks/:id', () => {
    ...
    it(`GET /bookmarks/:id sends { url: 'https://nodejs.org/', title: 'Node.js' } as json`, (done) => {
      request(app)
        .get('/bookmarks/1')
        .expect(200)
        .expect('Content-Type', /json/)
    ...
    it(`GET /bookmarks/:id that doesn't exist, sends { error: 'Bookmark not found' } as json`, (done) => {
      request(app)
        .get('/bookmarks/5')
        .expect(404)
        .expect('Content-Type', /json/)
